...
import dj.djibgate.DjibGateApp;
...
import static dj.djibgate.web.rest.TestUtil.ID_TOKEN;
import static dj.djibgate.web.rest.TestUtil.authenticationToken;
 ...
 */
@SpringBootTest(classes = {DjibGateApp.class, TestSecurityConfiguration.class})
