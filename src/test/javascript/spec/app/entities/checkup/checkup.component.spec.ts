...
import { CheckupComponent } from 'app/entities/checkup/checkup.component';
import { CheckupService } from 'app/entities/checkup/checkup.service';
import { Checkup } from 'app/shared/model/checkup.model';

describe('Component Tests', () => {
  describe('Checkup Management Component', () => {
    let comp: CheckupComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CheckupComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.checkups && comp.checkups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
